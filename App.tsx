...
///////////////////////////////////////WRITE TO DATABASE (FIRESTORE)//////////////////////
  ...
  return (
    <View style={styles.container}>
      ...
      <Button title="Click Here to Send to Database" onPress={writeToDatabase}></Button>
      <Button title="Click Here to Send a New User to Firestore" onPress={writeToFirestore}></Button>
      <Button title="Click Here to Add a Business to Firestore" onPress={addBusinesstoFireStore}></Button>
      <Button title="Click Here to Add a Listing" onPress={addPostingtoFireStore}></Button>
      <Button title="Click Here to Business to Buy a Post" onPress={addApprovedPost}></Button>
